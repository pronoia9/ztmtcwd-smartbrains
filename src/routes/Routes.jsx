...
export default function App(props) {
  ...
  return (
    <Routes>
      ...
      {/* Not implemented yet. Have to implement a search history save in the database first. */}
      <Route path='/profile/:userId/gallery' element={user ? <Navigate to={`/profile/${user.id}`} /> : <Navigate to='/' />}></Route>
